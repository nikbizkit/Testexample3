...
<section id="section0" class="header">
   <?php
require ('connect.php');
$material = trim($_REQUEST['material']);

$ceh_name = trim($_REQUEST['Ceh']);
$status = trim($_REQUEST['Statuss']);

$sql = "SELECT * FROM materials WHERE  material_mark='$material' ";
$result = mysqli_query($connection, $sql);
$row = mysqli_fetch_array($result);
echo "<table align='center' class='vivod'>
<th class='vivodth' align='right' style='width:200px;'>Название материала</th> 
<th  class='vivodth' align='center' style='width:200px;'>Диаметр</th> 
<th  class='vivodth' align='center' style='width:200px;'>Стенка</th> 
</tr>
</table>";
...
<td class='vivodtd' align='center' style='width:200px;'>".$row['material_mark']."</td>
<td class='vivodtd' align='center' style='width:200px;'>".$row['diametr_reg']."</td>
<td class='vivodtd' align='center' style='width:200px;'>".$row['stenka']."</td>
