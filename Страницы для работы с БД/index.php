<head>
<meta charset="utf-8">
<title>Поиск производителя</title>
<!--=================================
Style Sheets
=================================-->
...
<section id="section0" class="header">
    <div class="container">
        <div class="headerInner">
            <h2>Найди производителя<br>быстро</h2>
            <p>Сейчас <b class="red">Now!</b></p>
            <div class="row mt-30">
             
               </div>
                <div class="col-md-4 col-sm-6">
                	<form method="post" action="select_rest.php">
					
					    
						<div class="select">
						<select  size=1 type="text" name="Ceh" placeholder="Производитель:"> 
					    ...
					    <input class="btn btn-default btn-head mt-20 mb-50" id="submit" type="submit" value="Найти производителя"><br/>
