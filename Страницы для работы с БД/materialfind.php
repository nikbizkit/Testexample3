...
<section id="section0" class="header">
    <div class="container">
        <div class="headerInner">
            <h2>Найди материал<br>быстро</h2>
            <p>Сейчас <b class="red">Now!</b></p>
            <div class="row mt-30">
             
               </div>
                <div class="col-md-4 col-sm-6">
                	<form method="post" action="select_proizv.php">
					    ...
					    <input class="btn btn-default btn-head mt-20 mb-50" id="submit" type="submit" value="Найти материал"><br/>
